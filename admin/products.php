...
<body>
  <nav>
    <input onchange="nav(this.id)" type="radio" id="list" name="nav" checked><label for="list">Список товров</label>
    <input onchange="nav(this.id)" type="radio" id="serch" name="nav"><label for="serch">Найти Товар</label>
    <input onchange="nav(this.id)" type="radio" id="chenge" name="nav"><label for="chenge">Редактирование товар</label>
    <input onchange="nav(this.id)" type="radio" id="create" name="nav"><label for="create">Создать товар</label>
  </nav>
  ...
  <div class="display" id="product_create" style="display: none;">
    <form id="create-product">
      ...
      <label for="price-viwe">Цена на показ</label>
      ...
      <label for="password">Количество покупок</label>
